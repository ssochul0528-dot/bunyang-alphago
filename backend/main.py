...
async def analyze_site(request: Optional[AnalyzeRequest] = None):
    ...
    try:
        ...
        {{
            ...
            "lms_copy_samples": [
                "(광고) [신뢰/종합] {{field_name}} - 완벽한 주거와 미래 가치의 중심\\n\\n안녕하세요, {{field_name}} 분양본부입니다.\\n입지부터 가격까지, 지역의 새로운 기준이 될 현장을 소개합니다.\\n\\n🏡 현장 핵심 포인트:\\n- {{field_keypoints}}\\n- 주변 시세 대비 {gap_percent}% 더 합리적인 분양가\\n- 신축 프리미엄과 압도적 생활권 공유\\n\\n🎁 한정 기간 특별 혜택:\\n- 계약금 {{down_payment}} 정액제로 입주 시까지 부담 제로\\n- 중도금 {{interest_benefit}} 파격 조건 적용\\n- 선착순 풀옵션 무상 제공 혜택까지\\n\\n지금 바로 상담 신청하시고 시세 차익 프리미엄을 선점하십시오.\\n\\n📞 분양 홍보관: 1600-0000\\n▶ 실시간 잔여세대 확인: [상담예약신청]",
                "(광고) [혜택집중] {{field_name}} - 마지막 선착순 조건변경 안내\\n\\n마포가 기다려온 단 하나의 기회, {{field_name}}입니다.\\n고민하시는 사이 로열층부터 빠르게 소진되고 있습니다.\\n\\n💰 강력한 금융 솔루션:\\n1. 초기 자금 부담을 줄인 계약금 {{down_payment}}\\n2. 금리 걱정 없는 {{interest_benefit}} 혜택 확정\\n3. 주변 시세와 비교할수록 커지는 {gap_percent}%의 자산 가치\\n\\n단순한 집을 넘어, 삶의 품격이 바뀌는 {{field_name}}에서 당신의 미래를 설계하십시오.\\n\\n📍 홍보관 위치 안내 및 상담\\n▶ 010-0000-0000 (24시간 문자 가능)",
                "(광고) [마감임박] 🚨 {{field_name}} 로열층 선착순 마감 5분 전!\\n\\n지금 이 문자를 받으셨다면 아직 기회가 남아 있습니다.\\n{{field_name}} 잔여 세대가 실시간으로 계약되고 있습니다.\\n\\n🔥 현재 상황:\\n- 84타입 남은 수량 단 3세대!\\n- 로열층/정남향 프리미엄 라인 마감 직전\\n- 시세 차익만 {gap_percent}%가 예상되는 압도적 수익성\\n\\n더 이상 망설이지 마세요. 내 집 마련의 꿈, 전문가와 상의하여 지금 결정하십시오.\\n\\n📞 긴급 상담 문의: 1600-1234\\n*방문 예약 시 특별 사은품 증정 중*"
            ],
            "channel_talk_samples": [
                "🔥 [{{field_name}}] 역대급 조건변경! 지금 호갱노노에서 가장 뜨거운 현장입니다. 입주까지 자금 걱정 없는 {{interest_benefit}} 혜택과 시세 대비 {gap_percent}% 낮은 압도적 가격 경쟁력을 직접 확인하세요. 마감 전 선착순 혜택을 선점하세요! (공백포함 150자 내외)",
                "🚨 [{{field_name}}] 실시간 잔여세대 급소진 안내! 현재 로열층 남은 수량 단 3개뿐입니다. 정남향/판상형 등 선호도 높은 호실부터 빠르게 계약 중! 주변 시세 대비 확실한 프리미엄이 보장되는 현장, 지금 바로 상담으로 유료급 입지 분석 리포트를 받아보세요.",
                "📊 [{{field_name}}] 고관여 타겟 전용 리얼 데이터 공개! '이 가격에 이 입지가 가능해?' 유저들이 주목하는 {{field_name}}의 진짜 가치. 호갱노노 분석 결과 학군, 상권, 미래가치까지 올인원 리포트를 무료 배포합니다. 3040 실수요자라면 절대 놓치지 마세요!"
            ]
        }}
        """
        ...
        return {
            ...
            "lms_copy_samples": [
                f"(광고) [신뢰/종합] {field_name} - 완벽한 주거와 미래 가치의 중심\n\n안녕하세요, {field_name} 분양본부입니다.\n입지부터 가격까지, 지역의 새로운 기준이 될 현장을 소개합니다.\n\n🏡 현장 핵심 포인트:\n- {field_keypoints if field_keypoints else '탁월한 입지와 미래가치'}\n- 주변 시세 대비 {gap_percent}% 더 합리적인 분양가\n- {address}의 풍부한 인프라와 압도적 생활권 공유\n\n🎁 한정 기간 특별 혜택:\n- 계약금 10% 정액제로 입주 시까지 자금 부담 제로\n- 중도금 무이자 파격 조건 적용\n- 선착순 풀옵션 무상 제공 혜택까지\n\n지금 바로 상담 신청하시고 인근 대비 약 {abs(market_gap):.0f}만원 이상의 시세 차익 프리미엄을 선점하십시오.\n\n📞 분양 홍보관: 1600-0000\n▶ 실시간 잔여세대 확인: [상담예약신청]",
                f"(광고) [혜택집중] {field_name} - 마지막 선착순 조건변경 안내\n\n지은 지 오래된 아파트에서 벗어날 단 하나의 기회, {field_name}입니다.\n고민하시는 사이 로열층부터 빠르게 소진되고 있습니다.\n\n💰 강력한 금융 솔루션:\n1. 초기 자금 부담을 획기적으로 줄인 파격 조건\n2. 금리 걱정 없는 무이자 혜택 확정\n3. 주변 시세와 비교할수록 커지는 {gap_percent}%의 자산 가치\n\n단순한 집을 넘어, 삶의 품격이 바뀌는 {field_name}에서 당신의 미래를 설계하십시오.\n\n📍 홍보관 위치 안내 및 상담\n▶ 010-0000-0000 (24시간 문자 가능)",
                f"(광고) [마감임박] 🚨 {field_name} 로열층 선착순 마감 직전 안내!\n\n지금 이 문자를 받으셨다면 아직 마지막 기회가 남아 있습니다.\n{field_name} 잔여 세대가 실시간으로 계약되고 있습니다.\n\n🔥 현재 상황:\n- 로열층/정남향 프리미엄 라인 마감 직전\n- 시세 차익만 {gap_percent}%가 예상되는 압도적 수익성\n- 오늘 하루만 방문객 200명 돌파, 줄 서서 기다리는 현장\n\n더 이상 망설이지 마세요. 내 집 마련의 꿈, 전문가와 상의하여 지금 결정하십시오.\n\n📞 긴급 상담 문의: 1600-1234\n*방문 예약 시 특별 사은품 증정 중*"
            ],
            "channel_talk_samples": [
                f"🔥 [{field_name}] 역대급 조건변경! 지금 호갱노노에서 가장 뜨거운 현장입니다. 입주까지 자금 걱정 없는 '중도금 무이자' 혜택과 시세 대비 {gap_percent}% 낮은 압도적 가격 경쟁력을 직접 확인하세요. 마감 전 선착순 혜택 선점 필수!",
                f"🚨 [{field_name}] 실시간 잔여세대 급소진 안내! 현재 로열층 남은 수량 단 3개뿐입니다. 정남향/판상형 등 인기 호실부터 빠르게 계약 중! 주변 시세 대비 확실한 프리미엄이 보장되는 현장, 지금 바로 상담으로 정밀 분석 리포트를 받아보세요.",
                f"📊 [{field_name}] 호갱노노 고관여 유저 전용 리포트! '이 가격에 이 입지가 가능해?' 사람들이 주목하는 {field_name}의 진짜 가치. 학군, 상권, 미래가치까지 올인원 리포트를 무료 배포합니다. 3040 실수요자라면 절대 놓치지 마세요!"
            ],
            "media_mix": [
                {"media": "메타/인스타", "feature": "정밀 타켓팅", "reason": "관심사 기반 도달", "strategy_example": "혜택 강조 광고"},
                {"media": "네이버", "feature": "검색 기반", "reason": "구매 의향 고객 확보", "strategy_example": "지역 키워드 점유"},
