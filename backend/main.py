...
async def analyze_site(request: Optional[AnalyzeRequest] = None):
    ...
    try:
        ...
        {{
            ...
            "lms_copy_samples": [
                "(광고) [신뢰/종합] {{field_name}}\n\n🏆 브랜드 파워와 압도적 입지\n주변 시세 대비 {gap_percent}% 더 합리적인 분양가!\n{{field_keypoints}}를 경험하세요.\n\n✅ 상담예약: 1600-0000",
                "(광고) [혜택집중] {{field_name}} 핵심 정보\n\n💰 계약금 {{down_payment}}만으로 입주까지!\n이자 걱정 없는 {{interest_benefit}} 파격 혜택\n주거 고민을 시원하게 해결해 드립니다.\n\n▶ 상담: 010-0000-0000",
                "(광고) [마감임박] {{field_name}} 잔여세대 안내\n\n🚨 실시간 계약 폭발! 로열층 마감 1분 전\n지금 신청하시면 '특별 사은품' 증정 혜택까지\n기회는 망설이는 순간 지나갑니다.\n\n📞 연락: 1600-1234"
            ],
            "channel_talk_samples": [
                "🔥 [{{field_name}}] 파격 조건변경 확정! 선착순 10세대 한정 특별 혜택을 지금 확인하세요.",
                "🚨 [{{field_name}}] 실시간 잔여세대 급소진! 로열층 남은 수량 3개, 지금 바로 선점하세요.",
                "💎 [{{field_name}}] 입지 분석 보고서: '이 가격에 이 인프라, 지역의 자존심' (호갱노노 고관여 유입용)"
            ]
        }}
        """
        ...
        return {
            ...
            "lms_copy_samples": [
                f"(광고) [신뢰/종합] {field_name}\n\n🏆 브랜드 파워와 압도적 입지\n주변 시세 대비 {gap_percent}% 더 합리적인 분양가!\n{field_keypoints if field_keypoints else '탁월한 입지'}를 직접 경험해 보세요.\n\n✅ 상담예약: 1600-0000",
                f"(광고) [혜택집중] {field_name} 특별분양\n\n💰 계약금 10%만으로 입주까지!\n이자 걱정 없는 '중도금 무이자' 파격 혜택\n주거 고민을 시원하게 해결해 드립니다.\n\n▶ 상담: 010-0000-0000",
                f"(광고) [마감임박] {field_name} 잔여세대 안내\n\n🚨 실시간 계약 폭발! 로열층 마감 1분 전\n지금 신청하시면 '특별 사은품' 증정 혜택까지\n기회는 망설이는 순간 지나갑니다.\n\n📞 연락: 1600-1234"
            ],
            "channel_talk_samples": [
                f"🔥 [{field_name}] 파격 조건변경 확정! 선착순 10세대 한정 특별 혜택을 지금 확인하세요.",
                f"🚨 [{field_name}] 실시간 잔여세대 급소진! 로열층 남은 수량 3개, 지금 바로 선점하세요.",
                f"💎 [{field_name}] 입지 분석 보고서: \"이 가격에 이 인프라, 지역의 자존심\" (호갱노노 고관여 유입용)"
            ],
            "media_mix": [
                {"media": "메타/인스타", "feature": "정밀 타켓팅", "reason": "관심사 기반 도달", "strategy_example": "혜택 강조 광고"},
                {"media": "네이버", "feature": "검색 기반", "reason": "구매 의향 고객 확보", "strategy_example": "지역 키워드 점유"},
